"""
Django settings for mep_project project.
...
SECRET_KEY = '3j3o-$ceem4%&n$mhh7^-e5)adykwn2@k%^$91g8p)(d#=t^t('
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'user_reg.context_processors.context_processor',
            ],
        },
    },
]
