...
class DeleteCheckboxWidget(forms.CheckboxInput):
    ...
    def render(self, name, value, attrs=None):
        ...
        if value:
            ...
            if self.is_image:
                s += u'<br /><img src="%s" width="100" height="100" alt="" />' % get_thumbnail(value,'100x100', crop='center', quality=65).url
            else:
...
add_introspection_rules([], ["past_productions_and_projects\.widgets\.RemovableImageField"])
'''
