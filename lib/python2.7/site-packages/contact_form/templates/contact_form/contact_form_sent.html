{% extends "contact_form/contact_base.html" %}
{% load i18n %}
...
{% block content %}
<!-- Start Home Section-->
<section class="sep-top-2x sep-bottom-3x" style="background-image: url({% static 'img/banner11.jpg' %});"></section>
<!-- End Home Section -->
  ...
  <div class="container">
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="section-title text-center">
              <div class="icon-box icon-horizontal icon-md">
                <div class="icon-content img-circle"><i class="fa fa-paper-plane"></i></div>
              </div>
              <h2 class="upper">Message Sent!</h2>
      ...
      <div class="row">
        <div class="col-md-6 sep-top-lg">
          ...
          <div class="icon-box-content">
                ...
                <p class="lead">Strathmore University, Ole Sangale Avenue, Madaraka, Nairobi, Kenya</p>
            </div>
          </div>
            <!--End icon box-->
            <!--Start icon box-->
            ...
            <div class="icon-box-content">
                ...
                <p>mbithe.nzomo@strathmore.edu</p>
            </div>
          </div>
            <!--End icon box-->
            <!--Start icon box-->
            <div class="icon-box icon-xs sep-bottom-xs icon-gradient">
              ...
              <div class="icon-box-content">
                  <h6 class="upper info-title">Office Hours</h6>
                  <p>Mon / Friday 09:00 - 12.00 / 14:00 - 17:00</p>
              </div>
            </div>
            <!--End icon box-->
        </div>
      <div class="col-md-6 sep-top-lg">
            <div class="contact-form">
              <div data-device="imac" data-orientation="landscape" data-color="black" class="device-mockup">
               <div class="device">
                  <div class="screen">
                    <img src="{% static 'img/banner12.jpg' %}" alt="" width="577" height="433" class="img-responsive">
                  </div>
              </div>
            </div>
            </div>
