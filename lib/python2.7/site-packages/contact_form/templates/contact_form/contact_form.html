...
{% block content %}
<!-- Start Home Section-->
<section class="sep-top-2x sep-bottom-3x" style="background-image: url({% static 'front-end/img/banner11.jpg' %});"></section>
<!-- End Home Section -->
	...
	<div class="container">
		  ...
		  <div class="col-md-8 col-md-offset-2">
  			<div class="section-title text-center">
    			...
    			<h2 class="upper">Contact Us</h2>
   	 			<p class="lead">Here's how to get in touch with the <em>My Event Planner </em> team.</p>
				</div>
  		</div>
		</div>
		<div class="row">
    	<div class="col-md-6 sep-top-lg">
        	...
        	<div data-wow-delay=".5s" class="icon-content img-circle wow flipInX"><i class="fa fa-map-marker"></i></div>
      			...
      			<p>Strathmore University, Ole Sangale Avenue, Madaraka, Nairobi, Kenya</p>
  				</div>
				</div>
  			<!--End icon box-->
  			<!--Start icon box-->
      	...
      	<!--Start icon box-->
            ...
            <div class="col-xs-12 col-md-6">
              <button type="submit" value="submit" data-wow-delay=".5s" class="btn btn-primary btn-lg wow bounceInRight"><i class="fa fa-paper-plane"></i> Send message</button>
            </div>
            <div class="col-xs-12 col-md-6">
